...
#define BL616CL_POWER_SUPPLY_INTERNAL_LDO 1
#define BL616CL_POWER_SUPPLY_EXT_DCDC_SOC 2
#define BL616CL_POWER_SUPPLY_EXT_DCDC_SYS 3
#define BL616CL_POWER_SUPPLY_EXT_DCDC_SOC_SYS 4
...
#define BL616CL_POWER_SUPPLY_USE_EXT_DCDC(mode) \
    (BL616CL_POWER_SUPPLY_SOC_USE_EXT_DCDC(mode) || BL616CL_POWER_SUPPLY_SYS_USE_EXT_DCDC(mode))
