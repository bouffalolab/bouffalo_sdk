...
static void bl_lp_fw_wifi_init(void)
{
...
static void bl_lp_fw_bcn_delay_init(void)
{
    /* sliding window init */
...
{
    if (iot2lp_para->bcn_delay_info->bcn_delay_sliding_win_status < iot2lp_para->bcn_delay_info->bcn_delay_sliding_win_size) {
        return 0;
    } else {
        return 1;
    }
