...
#define SDIO3_IRQ_EVENT_FUNC2_RESET           (3) /*!< Func2 reset  */
#define SDIO3_IRQ_EVENT_DNLD_CPL              (4) /*!< Dnld complete  */
#define SDIO3_IRQ_EVENT_UPLD_CPL              (5) /*!< Upld complete  */
#define SDIO3_IRQ_EVENT_CMD11_SWITCH          (6) /*!< Switch to 1.8v  */
#define SDIO3_IRQ_EVENT_CMD11_CLK_STOP        (7) /*!< Switch to 1.8v  */
#define SDIO3_IRQ_EVENT_CMD11_CLK_START       (8) /*!< Switch to 1.8v  */

#define SDIO3_IRQ_EVENT_ERR_CRC               (9)  /*!< CRC error  */
#define SDIO3_IRQ_EVENT_ERR_DNLD_ABORT        (10) /*!< Host aborts the FunctionX DNLD Operation */
#define SDIO3_IRQ_EVENT_ERR_UPLD_ABORT        (11) /*!< Host aborts the FunctionX UPLD Operation */
#define SDIO3_IRQ_EVENT_ERR_ADMA              (12) /*!< ADMA error  */
#define SDIO3_IRQ_EVENT_ERR_DNLD_QUEUE        (13) /*!< dnld queue error  */
#define SDIO3_IRQ_EVENT_ERR_UPLD_QUEUE        (14) /*!< upld queue error  */
#define SDIO3_IRQ_EVENT_ERR_UNKNOWN           (15) /*!< other error */
/**
  * @}
  */
