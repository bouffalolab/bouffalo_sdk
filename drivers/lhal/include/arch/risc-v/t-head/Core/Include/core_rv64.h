...
*/
__STATIC_INLINE void csi_icache_invalid_range(void *addr, int64_t dsize)
{
#if (__ICACHE_PRESENT == 1U)
    uint64_t linesize = (0x01 << CACHE_INV_ADDR_Pos);
    int64_t op_size = dsize + (uint64_t)addr % linesize;
