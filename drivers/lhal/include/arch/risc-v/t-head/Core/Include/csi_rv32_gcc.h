...
__ALWAYS_STATIC_INLINE void __CUSTOM_ICACHE_IPA(uint32_t addr) 
{
    __asm__ volatile (
        ".insn i 0x0b, 0x0, x0, %0, 0x38"
        : 
        : "r" (addr)
        : "memory"
    );
