 ...
 */
__STATIC_FORCEINLINE void __ECLIC_EnableIRQ(int IRQn)
{
 ...
 * - \ref ECLIC_DisableIRQ
 */
__STATIC_FORCEINLINE uint32_t __ECLIC_GetEnableIRQ(int IRQn)
{
 ...
 * - \ref ECLIC_EnableIRQ
 */
__STATIC_FORCEINLINE void __ECLIC_DisableIRQ(int IRQn)
{
    ECLIC->CTRL[IRQn].INTIE &= ~CLIC_INTIE_IE_Msk;
}
 ...
 */
__STATIC_FORCEINLINE int32_t __ECLIC_GetPendingIRQ(int IRQn)
{
 ...
 * - \ref ECLIC_ClearPendingIRQ
 */
__STATIC_FORCEINLINE void __ECLIC_SetPendingIRQ(int IRQn)
{
 ...
 * - \ref ECLIC_GetPendingIRQ
 */
__STATIC_FORCEINLINE void __ECLIC_ClearPendingIRQ(int IRQn)
{
    ECLIC->CTRL[IRQn].INTIP &= ~CLIC_INTIP_IP_Msk;
}
 ...
 */
__STATIC_FORCEINLINE void __ECLIC_SetTrigIRQ(int IRQn, uint32_t trig)
{
 ...
 */
__STATIC_FORCEINLINE uint32_t __ECLIC_GetTrigIRQ(int IRQn)
{
 ...
 * - \ref ECLIC_GetShvIRQ
 */
__STATIC_FORCEINLINE void __ECLIC_SetShvIRQ(int IRQn, uint32_t shv)
{
    uint8_t temp = ECLIC->CTRL[IRQn].INTATTR;
 ...
 * - \ref ECLIC_SetShvIRQ
 */
__STATIC_FORCEINLINE uint32_t __ECLIC_GetShvIRQ(int IRQn)
{
 ...
 */
__STATIC_FORCEINLINE void __ECLIC_SetCtrlIRQ(int IRQn, uint8_t intctrl)
{
 ...
 */
__STATIC_FORCEINLINE uint8_t __ECLIC_GetCtrlIRQ(int IRQn)
{
 ...
 */
__STATIC_INLINE void __ECLIC_SetLevelIRQ(int IRQn, uint8_t lvl_abs)
{
 ...
 */
__STATIC_INLINE uint8_t __ECLIC_GetLevelIRQ(int IRQn)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
 ...
 */
__STATIC_INLINE void __ECLIC_SetPriorityIRQ(int IRQn, uint8_t pri)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
    if (nlbits < intctlbits) {
 ...
 */
__STATIC_INLINE uint8_t __ECLIC_GetPriorityIRQ(int IRQn)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
    if (nlbits < intctlbits) {
 ...
 * - \ref ECLIC_GetVector
 */
__STATIC_INLINE void __ECLIC_SetVector(int IRQn, rv_csr_t vector)
{
 ...
 *     - \ref ECLIC_SetVector
 */
__STATIC_FORCEINLINE rv_csr_t __ECLIC_GetVector(int IRQn)
{
#if __RISCV_XLEN == 32
 ...
 */
__STATIC_FORCEINLINE void __ECLIC_SetModeIRQ(int IRQn, uint32_t mode)
{
    /*
 ...
 */
__STATIC_FORCEINLINE void __ECLIC_SetTrigIRQ_S(int IRQn, uint32_t trig)
{
 ...
 */
__STATIC_FORCEINLINE uint8_t __ECLIC_GetTrigIRQ_S(int IRQn)
{
 ...
 */
__STATIC_FORCEINLINE void __ECLIC_SetShvIRQ_S(int IRQn, uint32_t shv)
{
    uint8_t temp = ECLIC->SCTRL[IRQn].INTATTR;
 ...
 */
__STATIC_FORCEINLINE uint8_t __ECLIC_GetShvIRQ_S(int IRQn)
{
 ...
 */
__STATIC_FORCEINLINE void __ECLIC_SetCtrlIRQ_S(int IRQn, uint8_t intctrl)
{
 ...
 */
__STATIC_FORCEINLINE uint8_t __ECLIC_GetCtrlIRQ_S(int IRQn)
{
 ...
 */
__STATIC_INLINE void __ECLIC_SetLevelIRQ_S(int IRQn, uint8_t lvl_abs)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
 ...
 */
__STATIC_INLINE uint8_t __ECLIC_GetLevelIRQ_S(int IRQn)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
 ...
 */
__STATIC_INLINE void __ECLIC_SetPriorityIRQ_S(int IRQn, uint8_t pri)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
    if (nlbits < intctlbits) {
 ...
 */
__STATIC_INLINE uint8_t __ECLIC_GetPriorityIRQ_S(int IRQn)
{
    uint8_t nlbits = __ECLIC_GetCfgNlbits();
    uint8_t intctlbits = (uint8_t)__ECLIC_INTCTLBITS;
    if (nlbits < intctlbits) {
 ...
 * - \ref ECLIC_DisableIRQ
 */
__STATIC_FORCEINLINE void __ECLIC_EnableIRQ_S(int IRQn)
{
 ...
 */
__STATIC_FORCEINLINE uint8_t __ECLIC_GetEnableIRQ_S(int IRQn)
{
 ...
 * - \ref ECLIC_EnableIRQ
 */
__STATIC_FORCEINLINE void __ECLIC_DisableIRQ_S(int IRQn)
{
    ECLIC->SCTRL[IRQn].INTIE &= ~CLIC_INTIE_IE_Msk;
}
 ...
 */
__STATIC_INLINE void __ECLIC_SetVector_S(int IRQn, rv_csr_t vector)
{
    volatile unsigned long vec_base;
 ...
 */
__STATIC_FORCEINLINE rv_csr_t __ECLIC_GetVector_S(int IRQn)
{
#if __RISCV_XLEN == 32
