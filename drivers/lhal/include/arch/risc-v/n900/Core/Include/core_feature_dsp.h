...
{
    __ASM volatile("kmmawb2.u %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    __ASM volatile("kmmawt2.u %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    unsigned long result;
    __ASM volatile("kslra16.u %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    unsigned long result;
    __ASM volatile("kslra32.u %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    unsigned long long result;
    __ASM volatile("dkwmmul.u %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long long result;
    __ASM volatile("dsmbb32.sra14 %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long long result;
    __ASM volatile("dsmbb32.sra32 %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long long result;
    __ASM volatile("dsmbt32.sra14 %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long long result;
    __ASM volatile("dsmbt32.sra32 %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long long result;
    __ASM volatile("dsmtt32.sra14 %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long long result;
    __ASM volatile("dsmtt32.sra32 %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    __ASM volatile("dsmaqa.su %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    __ASM volatile("dkmaxda32 %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    __ASM volatile("dkmadrs32 %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    __ASM volatile("dkmaxds32 %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    __ASM volatile("dkmsxda32 %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    __ASM volatile("ddsmaqa.su %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    long result;
    __ASM volatile("dsmxs32.u %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    long result;
    __ASM volatile("dsmxa32.u %0, %1, %2"
                   : "=r"(result)
                   : "r"(a), "r"(b));
    return result;
}
...
{
    __ASM volatile("dsmaxda16 %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return (long)t;
}
...
{
    __ASM volatile("dksms32.u %0, %1, %2"
                   : "+r"(t)
                   : "r"(a), "r"(b));
    return t;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x7A,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x5A,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x62,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x6A,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x72,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x7B,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x5B,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x63,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x6B,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x73,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x78,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x58,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x60,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x68,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x70,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x79,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x59,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x61,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x69,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
{
    unsigned long r;
    __asm(".insn r 0x7F, 0x2, 0x71,   %0,%1,%2"
          : "=r"(r)
          : "r"(a), "r"(b));
    return r;
}
...
#define __PKHBT64(ARG1, ARG2, ARG3) ((ARG3 == 0)  ? __RV_PKTB16(ARG2, ARG1) :                                                   \
                                     (ARG3 == 16) ? __RV_PKBB16(ARG2, ARG1) :                                                   \
                                                    ((int64_t)((((uint32_t)((uint64_t)ARG1 >> 32)) & 0x0000FFFFUL) |            \
                                                               ((((uint32_t)((uint64_t)ARG2 >> 32)) << (ARG3)) & 0xFFFF0000UL)) \
                                                     << 32) |                                                                   \
...
#define __PKHTB64(ARG1, ARG2, ARG3) ((ARG3 == 0)  ? __RV_PKTB16(ARG1, ARG2) :                                                    \
                                     (ARG3 == 16) ? __RV_PKTT16(ARG1, ARG2) :                                                    \
                                                    ((uint64_t)(((uint32_t)((uint64_t)ARG1 >> 32) & 0xFFFF0000UL) |              \
                                                                ((((uint32_t)((uint64_t)ARG2 >> 32)) >> (ARG3)) & 0x0000FFFFUL)) \
                                                     << 32) |                                                                    \
