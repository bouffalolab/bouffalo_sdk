...
#define GPIO_FUNC_JTAG    (14 << GPIO_FUNC_SHIFT)
#define GPIO_FUNC_KEY_SCAN_IN    (21 << GPIO_FUNC_SHIFT)
#define GPIO_FUNC_KEY_SCAN_DRIVE (22 << GPIO_FUNC_SHIFT)
...
#define GPIO_FUNC_UART3     (18 << GPIO_FUNC_SHIFT)
#define GPIO_FUNC_KEY_SCAN_IN    (19 << GPIO_FUNC_SHIFT)
#define GPIO_FUNC_KEY_SCAN_DRIVE (20 << GPIO_FUNC_SHIFT)
