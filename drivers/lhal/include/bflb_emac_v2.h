#ifndef _BFLB_EMAC_V2_H
#define _BFLB_EMAC_V2_H
 ...
 *
 */
struct bflb_emac_v2_dma_desc_s {
...
#define bflb_emac_v2_is_desc_owned_by_dma(desc)              ((desc->status & EMAC_V2_DESC_OWN_BY_DMA) == EMAC_V2_DESC_OWN_BY_DMA)
#define bflb_emac_v2_get_rx_desc_frame_length(status)        ((status & EMAC_V2_DESC_FRAME_LEN_MASK) >> EMAC_V2_DESC_FRAME_LEN_SHIFT)
#define bflb_emac_v2_is_desc_valid(status)                   ((status & EMAC_V2_DESC_ERROR) == 0)
#define bflb_emac_v2_is_desc_empty(desc)                     (((desc->length & EMAC_V2_DESC_SIZE1_MASK) == 0) && ((desc->length & EMAC_V2_DESC_SIZE2_MASK) == 0))
#define bflb_emac_v2_is_rx_desc_valid(status)                ((status & EMAC_V2_DESC_ERROR) == 0) && ((status & EMAC_V2_DESC_RX_FIRST) == EMAC_V2_DESC_RX_FIRST) && ((status & EMAC_V2_DESC_RX_LAST) == EMAC_V2_DESC_RX_LAST)
#define bflb_emac_v2_is_tx_aborted(status)                   (((status & EMAC_V2_DESC_TX_LATE_COLLISION) == EMAC_V2_DESC_TX_LATE_COLLISION) | ((status & EMAC_V2_DESC_TX_EXC_COLLISIONS) == EMAC_V2_DESC_TX_EXC_COLLISIONS))
#define bflb_emac_v2_is_tx_carrier_error(status)             (((status & EMAC_V2_DESC_TX_LOST_CARRIER) == EMAC_V2_DESC_TX_LOST_CARRIER) | ((status & EMAC_V2_DESC_TX_NO_CARRIER) == EMAC_V2_DESC_TX_NO_CARRIER))
#define bflb_emac_v2_get_tx_collision_count(status)          ((status & EMAC_V2_DESC_TX_COLL_MASK) >> EMAC_V2_DESC_TX_COLL_SHIFT)
#define bflb_emac_v2_is_exc_tx_collisions(status)            ((status & EMAC_V2_DESC_TX_EXC_COLLISIONS) == EMAC_V2_DESC_TX_EXC_COLLISIONS)
#define bflb_emac_v2_is_rx_frame_damaged(status)             (((status & EMAC_V2_DESC_RX_DAMAGED) == EMAC_V2_DESC_RX_DAMAGED) | ((status & EMAC_V2_DESC_RX_COLLISION) == EMAC_V2_DESC_RX_COLLISION))
#define bflb_emac_v2_is_rx_frame_collision(status)           ((status & EMAC_V2_DESC_RX_COLLISION) == EMAC_V2_DESC_RX_COLLISION)
#define bflb_emac_v2_is_rx_crc(status)                       ((status & EMAC_V2_DESC_RX_CRC) == EMAC_V2_DESC_RX_CRC)
#define bflb_emac_v2_is_frame_dribbling_errors(status)       ((status & EMAC_V2_DESC_RX_DRIBBLING) == EMAC_V2_DESC_RX_DRIBBLING)
#define bflb_emac_v2_is_rx_frame_length_errors(status)       ((status & EMAC_V2_DESC_RX_LEN_ERROR) == EMAC_V2_DESC_RX_LEN_ERROR)
#define bflb_emac_v2_is_last_rx_desc(desc)                   (((desc->length & EMAC_V2_DESC_RX_END_OF_RING) == EMAC_V2_DESC_RX_END_OF_RING))
#define bflb_emac_v2_is_last_tx_desc(desc)                   (((desc->status & EMAC_V2_DESC_TX_END_OF_RING) == EMAC_V2_DESC_TX_END_OF_RING))
#define bflb_emac_v2_tx_checksum_offload_ipv4hdr(desc)       (desc->status = ((desc->status & (~EMAC_V2_DESC_TX_CIS_MASK)) | EMAC_V2_DESC_TX_CIS_IPV4_HDR_CS))
#define bflb_emac_v2_tx_checksum_offload_bypass(desc)        (desc->status = (desc->status & (~EMAC_V2_DESC_TX_CIS_MASK)))
#define bflb_emac_v2_tx_checksum_offload_tcponly(desc)       (desc->status = ((desc->status & (~EMAC_V2_DESC_TX_CIS_MASK)) | EMAC_V2_DESC_TX_CIS_TCP_ONLY_CS))
#define bflb_emac_v2_tx_checksum_offload_tcp_pseudo(desc)    (desc->status = ((desc->status & (~EMAC_V2_DESC_TX_CIS_MASK)) | EMAC_V2_DESC_TX_CIS_TCP_PSEUDO_CS))
#define bflb_emac_v2_take_desc_ownership(desc)               (desc->status &= ~EMAC_V2_DESC_OWN_BY_DMA)
#define bflb_emac_v2_is_ext_status(status)                   ((status & EMAC_V2_DESC_RX_EXT_STS) != 0)
#define bflb_emac_v2_is_tx_payload_checksum_error(status)    ((status & EMAC_V2_DESC_TX_PAY_CHK_ERROR) == EMAC_V2_DESC_TX_PAY_CHK_ERROR)
#define bflb_emac_v2_is_tx_ipv4header_checksum_error(status) ((status & EMAC_V2_DESC_TX_IPV4_CHK_ERROR) == EMAC_V2_DESC_TX_IPV4_CHK_ERROR)
#define bflb_emac_v2_es_is_ip_header_error(ext_status)       ((ext_status & EMAC_V2_EDESC_RX_IP_HEADER_ERROR) == EMAC_V2_EDESC_RX_IP_HEADER_ERROR)
#define bflb_emac_v2_es_is_rx_checksum_bypassed(ext_status)  ((ext_status & EMAC_V2_EDESC_RX_CHKSUM_BYPASS) == EMAC_V2_EDESC_RX_CHKSUM_BYPASS)
#define bflb_emac_v2_es_is_ip_payload_error(ext_status)      ((ext_status & EMAC_V2_EDESC_RX_IP_PAYLOAD_ERROR) == EMAC_V2_EDESC_RX_IP_PAYLOAD_ERROR)
