...
/** @defgroup PWM_IO_SEL pwm io select definition
  * @{
  */
#define PWM_IO_SEL_SINGLE_END (0)
#define PWM_IO_SEL_DIFF_END   (1)
/**
  * @}
  */
...
/** @defgroup PWM_IO_SEL_1 pwm io select 1 definition
  * @{
  */
#define PWM_IO_SEL_1_SINGLE_END (0)
#define PWM_IO_SEL_1_BREAK      (1)
/**
  * @}
  */
#endif
