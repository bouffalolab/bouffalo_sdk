...
#ifndef BOOTROM
struct bflb_device_s bl616cl_device_table[] = {
#else
const struct bflb_device_s bl616cl_device_table[] = {
#endif
    { .name = BFLB_NAME_ADC_V2_0,
      .reg_base = GLB_BASE,
      .irq_num = BL616CL_IRQ_GPADC_DMA,
      .idx = 0,
      .sub_idx = 0,
    ...
    { .name = BFLB_NAME_UART0,
      .reg_base = UART0_BASE,
      .irq_num = BL616CL_IRQ_UART0,
      .idx = 0,
      .dev_type = BFLB_DEVICE_TYPE_UART,
      .user_data = NULL },
    { .name = BFLB_NAME_UART1,
      .reg_base = UART1_BASE,
      .irq_num = BL616CL_IRQ_UART1,
      .idx = 1,
      .dev_type = BFLB_DEVICE_TYPE_UART,
      .user_data = NULL },
    { .name = BFLB_NAME_UART2,
      .reg_base = UART2_BASE,
      .irq_num = BL616CL_IRQ_UART2,
      .idx = 2,
      .dev_type = BFLB_DEVICE_TYPE_UART,
      .user_data = NULL },
    { .name = BFLB_NAME_SPI0,
      .reg_base = SPI0_BASE,
      .irq_num = BL616CL_IRQ_SPI0,
      .idx = 0,
      .dev_type = BFLB_DEVICE_TYPE_SPI,
      .user_data = NULL },
    { .name = BFLB_NAME_SPI1,
      .reg_base = SPI1_BASE,
      .irq_num = BL616CL_IRQ_SPI1,
      .idx = 1,
      .dev_type = BFLB_DEVICE_TYPE_SPI,
      .user_data = NULL },
    { .name = BFLB_NAME_PWM_V2_0,
      .reg_base = PWM_BASE,
      .irq_num = BL616CL_IRQ_PWM,
      .idx = 0,
      .sub_idx = 0,
    ...
    { .name = BFLB_NAME_TIMER0_CAPTURE,
      .reg_base = TIMER_BASE,
      .irq_num = BL616CL_IRQ_LTMR_GPIO_LAT,
      .idx = 0,
      .sub_idx = 0,
      .dev_type = BFLB_DEVICE_TYPE_TIMER,
      .user_data = NULL },
    ...
    { .name = BFLB_NAME_CAM0,
      ...
      .irq_num = BL616CL_IRQ_DVP2BUS_INT0,
      .idx = 0,
      .sub_idx = 0,
    ...
    { .name = BFLB_NAME_CAM1,
      ...
      .irq_num = BL616CL_IRQ_DVP2BUS_INT1,
      .idx = 0,
      .sub_idx = 0,
      .dev_type = BFLB_DEVICE_TYPE_CAMERA,
      .user_data = NULL },
...
struct bflb_device_s *bflb_device_get_by_name(const char *name)
{
    for (uint8_t i = 0; i < sizeof(bl616cl_device_table) / sizeof(bl616cl_device_table[0]); i++) {
        if (arch_strcmp(bl616cl_device_table[i].name, name) == 0) {
            return (struct bflb_device_s *)&bl616cl_device_table[i];
        }
    }
    LHAL_PARAM_ASSERT(0);
