...
typedef enum {
    ...
    BFLB_LHAL_ROMAPI_INDEX_bflb_pwm_v2_get_duty                              = 212,
    ...
    BFLB_LHAL_ROMAPI_INDEX_bflb_rtc_get_time                                 = 225,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_init                                     = 226,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_adma2_desc_init                          = 227,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_cmd_cfg                                  = 228,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_data_cfg                                 = 229,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_tranfer_start                            = 230,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_get_resp                                 = 231,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_sta_en                                   = 232,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_sta_en_get                               = 233,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_sta_int_en                               = 234,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_sta_int_en_get                           = 235,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_sta_get                                  = 236,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_sta_clr                                  = 237,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sdh_feature_control                          = 238,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_init                                     = 239,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_deinit                                   = 240,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_select_hwkey                             = 241,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_set_mode                                 = 242,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_setkey                                   = 243,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_encrypt                                  = 244,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_decrypt                                  = 245,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_link_init                                = 246,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_link_deinit                              = 247,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_link_update                              = 248,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group0_request_aes_access                    = 249,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group1_request_aes_access                    = 250,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group0_release_aes_access                    = 251,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group1_release_aes_access                    = 252,
    BFLB_LHAL_ROMAPI_INDEX_bflb_aes_set_hwkey_source                         = 253,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha_init                                     = 254,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_start                                   = 255,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha256_start                                 = 256,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha512_start                                 = 257,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_update                                  = 258,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_once_padded                             = 259,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha256_update                                = 260,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha512_update                                = 261,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_finish                                  = 262,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha256_finish                                = 263,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha512_finish                                = 264,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha_link_init                                = 265,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha_link_deinit                              = 266,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_link_start                              = 267,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha256_link_start                            = 268,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha512_link_start                            = 269,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_link_update                             = 270,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha256_link_update                           = 271,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha512_link_update                           = 272,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha1_link_finish                             = 273,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha256_link_finish                           = 274,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha512_link_finish                           = 275,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group0_request_sha_access                    = 276,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group1_request_sha_access                    = 277,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group0_release_sha_access                    = 278,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group1_release_sha_access                    = 279,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sha_crc32_link_work                          = 280,
    BFLB_LHAL_ROMAPI_INDEX_bflb_trng_read                                    = 281,
    BFLB_LHAL_ROMAPI_INDEX_bflb_trng_readlen                                 = 282,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group0_request_trng_access                   = 283,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group1_request_trng_access                   = 284,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group0_release_trng_access                   = 285,
    BFLB_LHAL_ROMAPI_INDEX_bflb_group1_release_trng_access                   = 286,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_init                                     = 287,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_deinit                                   = 288,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_link_txdma                               = 289,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_link_rxdma                               = 290,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_poll_send                                = 291,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_poll_exchange                            = 292,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_txint_mask                               = 293,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_rxint_mask                               = 294,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_tcint_mask                               = 295,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_rtoint_mask                              = 296,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_errint_mask                              = 297,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_get_intstatus                            = 298,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_int_clear                                = 299,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_isbusy                                   = 300,
    BFLB_LHAL_ROMAPI_INDEX_bflb_spi_feature_control                          = 301,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_init                                   = 302,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_deinit                                 = 303,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_start                                  = 304,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_stop                                   = 305,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_set_preloadvalue                       = 306,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_set_compvalue                          = 307,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_get_compvalue                          = 308,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_get_countervalue                       = 309,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_compint_mask                           = 310,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_get_compint_status                     = 311,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_compint_clear                          = 312,
    BFLB_LHAL_ROMAPI_INDEX_bflb_timer_capture_init                           = 313,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_init                                    = 314,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_deinit                                  = 315,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_enable                                  = 316,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_disable                                 = 317,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_link_txdma                              = 318,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_link_rxdma                              = 319,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_putchar                                 = 320,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_getchar                                 = 321,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_put                                     = 322,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_put_block                               = 323,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_get                                     = 324,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_wait_tx_done                            = 325,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_txready                                 = 326,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_txempty                                 = 327,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_rxavailable                             = 328,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_txint_mask                              = 329,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_rxint_mask                              = 330,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_errint_mask                             = 331,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_get_intstatus                           = 332,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_int_clear                               = 333,
    BFLB_LHAL_ROMAPI_INDEX_bflb_uart_feature_control                         = 334,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_init                                     = 335,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_start                                    = 336,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_stop                                     = 337,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_get_countervalue                         = 338,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_set_countervalue                         = 339,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_reset_countervalue                       = 340,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wdg_compint_clear                            = 341,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_pin_init                                  = 342,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_init                                      = 343,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_enable                                    = 344,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_disable                                   = 345,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_get_fifo_available_cnt                    = 346,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_push_fifo                                 = 347,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_push_fifo_force                           = 348,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_clear_fifo                                = 349,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_enable_dma                                = 350,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_disable_dma                               = 351,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_get_int_status                            = 352,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_int_mask                                  = 353,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_int_unmask                                = 354,
    BFLB_LHAL_ROMAPI_INDEX_bflb_wo_int_clear                                 = 355,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_callapi_before                  = 356,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_callapi_after                   = 357,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_get_param                       = 358,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_region_foreach                  = 359,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_get_lockbits                    = 360,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_set_lockbits                    = 361,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_get_locked                      = 362,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_set_locked                      = 363,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_get_info_by_idx                 = 364,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_valid_by_idx                    = 365,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_read_by_idx                     = 366,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_write_by_idx                    = 367,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_erase_by_idx                    = 368,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_get_info                        = 369,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_valid                           = 370,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_read                            = 371,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_write                           = 372,
    BFLB_LHAL_ROMAPI_INDEX_bflb_flash_secreg_erase                           = 373,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_init_ext_flash_gpio                   = 374,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_deinit_ext_flash_gpio                 = 375,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_init_flash_gpio                       = 376,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_init_flash2_gpio                      = 377,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_flash_identify                        = 378,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_get_flash_cfg_need_lock               = 379,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_flash_init                            = 380,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_cfg_sbus2_flash_init                      = 381,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_enable                               = 382,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_io_delay                         = 383,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_io_delay                         = 384,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_cs_clk_delay                     = 385,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_cs_clk_delay                     = 386,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_flash_io_cs_clk_delay            = 387,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_flash_io_cs_clk_delay            = 388,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_dqs_delay                        = 389,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_bank2_enable                         = 390,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sbus2_hold_sram                      = 391,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sbus2_release_sram                   = 392,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sbus2_replace                        = 393,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sbus2_revoke_replace                 = 394,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sbus2_set_delay                      = 395,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_remap_set                            = 396,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_32bits_addr_en                       = 397,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_clock_delay                      = 398,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_clock_delay                      = 399,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_wrap_queue_value                 = 400,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_cmds_set                             = 401,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_select_pad                           = 402,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sbus_select_bank                     = 403,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_owner                            = 404,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_owner                            = 405,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_owner_flag                       = 406,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_owner_flag                       = 407,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_disable                              = 408,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_enable_be                        = 409,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_enable_le                        = 410,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_region                       = 411,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_key                          = 412,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_key_be                       = 413,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_iv                           = 414,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_iv_be                        = 415,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_region_offset                = 416,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_xts_set_key                      = 417,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_xts_set_key_be                   = 418,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_xts_set_iv                       = 419,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_xts_set_iv_be                    = 420,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_mode                         = 421,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_enable                           = 422,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_disable                          = 423,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_is_aes_enable                        = 424,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_set_flash_image_offset               = 425,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_flash_image_offset               = 426,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_lock_flash_image_offset              = 427,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_select_clock                         = 428,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_sendcmd                              = 429,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_disable_wrap_access                  = 430,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_xip_set                              = 431,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_get_busy_state                       = 432,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_get_iv_be                        = 433,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_get_iv_le                        = 434,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_decrypt_region_be            = 435,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sf_ctrl_aes_set_decrypt_region_le            = 436,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_init                                  = 437,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_set_spi_mode                          = 438,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_read_reg                              = 439,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_write_reg                             = 440,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_read_reg_with_cmd                     = 441,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_write_reg_with_cmd                    = 442,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_busy                                  = 443,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_write_enable                          = 444,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_qspi_enable                           = 445,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_qspi_disable                          = 446,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_volatile_reg_write_enable             = 447,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_chip_erase                            = 448,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_sector_erase                          = 449,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_blk32_erase                           = 450,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_blk64_erase                           = 451,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_erase                                 = 452,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_get_uniqueid                          = 453,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_get_jedecid                           = 454,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_get_deviceid                          = 455,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_powerdown                             = 456,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_release_powerdown                     = 457,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_restore_from_powerdown                = 458,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_set_burst_wrap                        = 459,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_disable_burst_wrap                    = 460,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_set_32bits_addr_mode                  = 461,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_software_reset                        = 462,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_reset_continue_read                   = 463,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_set_xip_cfg                           = 464,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_xip_read_enable                       = 465,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_xip_read_disable                      = 466,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_rcv_enable                            = 467,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_erase_security_register               = 468,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_program_security_register             = 469,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_read_security_register                = 470,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_clear_status_register                 = 471,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_read                                  = 472,
    BFLB_LHAL_ROMAPI_INDEX_bflb_sflash_program                               = 473,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_state_save                        = 474,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_state_restore                     = 475,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_erase_need_lock                   = 476,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_write_need_lock                   = 477,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_read_need_lock                    = 478,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_get_jedecid_need_lock             = 479,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_get_deviceid_need_lock            = 480,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_get_uniqueid_need_lock            = 481,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_clear_status_register_need_lock   = 482,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_read_via_cache_need_lock          = 483,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_opt_enter                         = 484,
    BFLB_LHAL_ROMAPI_INDEX_bflb_xip_sflash_opt_exit                          = 485,
...
#define romapi_bflb_pwm_v2_get_duty \
    ((void (*)(struct bflb_device_s *dev, uint8_t ch, uint32_t *delta, uint32_t *period)) \
    ROM_APITABLE[BFLB_LHAL_ROMAPI_INDEX_bflb_pwm_v2_get_duty])
