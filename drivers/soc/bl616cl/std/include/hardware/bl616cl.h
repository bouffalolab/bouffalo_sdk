...
//#define BL616CL_OCRAM_BUSREMAP_BASE            (0x22FC0000)
//#define BL616CL_OCRAM_BUSREMAP_END             (0x22FC0000 + 224 * 1024)
//#define BL616CL_OCRAM_BUSREMAP_CACHEABLE_BASE  (0x62FC0000)
//#define BL616CL_OCRAM_BUSREMAP_CACHEABLE_END   (0x62FC0000 + 224 * 1024)
...
//#define BL616CL_WRAM_BUSREMAP_BASE             (0x23010000)
//#define BL616CL_WRAM_BUSREMAP_END              (0x23010000 + 160 * 1024)
//#define BL616CL_WRAM_BUSREMAP_CACHEABLE_BASE   (0x63010000)
//#define BL616CL_WRAM_BUSREMAP_CACHEABLE_END    (0x63010000 + 160 * 1024)

#define BL616CL_FLASH_XIP_BASE                 (0x80000000)
#define BL616CL_FLASH_XIP_END                  (0x80000000 + 64 * 1024 * 1024)
//#define BL616CL_FLASH_XIP_REMAP0_BASE          (0xD0000000)
//#define BL616CL_FLASH_XIP_REMAP0_END           (0xD0000000 + 64 * 1024 * 1024)
//#define BL616CL_FLASH_XIP_BUSREMAP_BASE        (0xA0000000)
//#define BL616CL_FLASH_XIP_BUSREMAP_END         (0xA0000000 + 64 * 1024 * 1024)

#define BL616CL_FLASH2_XIP_BASE                (0x84000000)
#define BL616CL_FLASH2_XIP_END                 (0x84000000 + 64 * 1024 * 1024)
//#define BL616CL_FLASH2_XIP_REMAP0_BASE         (0xD4000000)
//#define BL616CL_FLASH2_XIP_REMAP0_END          (0xD4000000 + 64 * 1024 * 1024)
//#define BL616CL_FLASH2_XIP_BUSREMAP_BASE       (0xA4000000)
//#define BL616CL_FLASH2_XIP_BUSREMAP_END        (0xA4000000 + 64 * 1024 * 1024)

#define BL616CL_PSRAM_BASE                     (0x88000000)
#define BL616CL_PSRAM_END                      (0x88000000 + 128 * 1024 * 1024)
//#define BL616CL_PSRAM_REMAP0_BASE              (0xD8000000)
//#define BL616CL_PSRAM_REMAP0_END               (0xD8000000 + 128 * 1024 * 1024)
//#define BL616CL_PSRAM_BUSREMAP_BASE            (0xA8000000)
//#define BL616CL_PSRAM_BUSREMAP_END             (0xA8000000 + 128 * 1024 * 1024)
...
//#define BL616CL_ALLRAM_BUSREMAP_BASE           (0x22FC0000)
//#define BL616CL_ALLRAM_BUSREMAP_END            (0x22FC0000 + 224 * 1024 + 160 * 1024)
//#define BL616CL_ALLRAM_BUSREMAP_CACHEABLE_BASE (0x62FC0000)
//#define BL616CL_ALLRAM_BUSREMAP_CACHEABLE_END  (0x62FC0000 + 224 * 1024 + 160 * 1024)
