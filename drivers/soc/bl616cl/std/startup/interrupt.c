...
const pFunc __Vectors[] __attribute__((section(".vector"), aligned(64))) = {
    ...
    default_interrupt_handler, //EXP_PERI_IRQHandler_Wrapper,             /* 16 + 64 */
    default_interrupt_handler, //LTMR_GPIO_LAT_IRQHandler_Wrapper,        /* 16 + 65 */
    default_interrupt_handler, //WDT1_IRQHandler_Wrapper,                 /* 16 + 66 */
};
#endif
