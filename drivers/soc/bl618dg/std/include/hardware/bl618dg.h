#ifndef __BL618DG_H__
#define __BL618DG_H__
...
#endif
/**
 * @brief BL618DG Interrupt Number Definition, according to the selected device
...
#endif
#if defined(CPU_LP)
    /******  BL618DG specific Interrupt Numbers **********************************************************************/
...
/**
 * @brief BL618DG Memory Map Definitions
 */
#if defined(CPU_MODEL_A0)
#define BL618DG_OCRAM_BASE           (0x21000000)
#define BL618DG_OCRAM_END            (0x21000000 + 320 * 1024)
#define BL618DG_OCRAM_CACHEABLE_BASE (0x61000000)
#define BL618DG_OCRAM_CACHEABLE_END  (0x61000000 + 320 * 1024)
#else
#define BL618DG_OCRAM_BASE           (0x21000000)
#define BL618DG_OCRAM_END            (0x21000000 + 320 * 1024)
#define BL618DG_OCRAM_CACHEABLE_BASE (0xA1000000)
#define BL618DG_OCRAM_CACHEABLE_END  (0xA1000000 + 320 * 1024)
#endif
//#define BL618DG_OCRAM_BUSREMAP_BASE            (0x23000000)
//#define BL618DG_OCRAM_BUSREMAP_END             (0x23000000 + 320 * 1024)
//#define BL618DG_OCRAM_BUSREMAP_CACHEABLE_BASE  (0x63000000)
//#define BL618DG_OCRAM_BUSREMAP_CACHEABLE_END   (0x63000000 + 320 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_WRAM_BASE           (0x21050000)
#define BL618DG_WRAM_END            (0x21050000 + 320 * 1024)
#define BL618DG_WRAM_CACHEABLE_BASE (0x61050000)
#define BL618DG_WRAM_CACHEABLE_END  (0x61050000 + 320 * 1024)
#else
#define BL618DG_WRAM_BASE           (0x21070000)
#define BL618DG_WRAM_END            (0x21070000 + 320 * 1024)
#define BL618DG_WRAM_CACHEABLE_BASE (0xA1070000)
#define BL618DG_WRAM_CACHEABLE_END  (0xA1070000 + 320 * 1024)
#endif
//#define BL618DG_WRAM_BUSREMAP_BASE             (0x23050000)
//#define BL618DG_WRAM_BUSREMAP_END              (0x23050000 + 320 * 1024)
//#define BL618DG_WRAM_BUSREMAP_CACHEABLE_BASE   (0x63050000)
//#define BL618DG_WRAM_BUSREMAP_CACHEABLE_END    (0x63050000 + 320 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_L2RAM_BASE           (0x210A0000)
#define BL618DG_L2RAM_END            (0x210A0000 + 160 * 1024)
#define BL618DG_L2RAM_CACHEABLE_BASE (0x610A0000)
#define BL618DG_L2RAM_CACHEABLE_END  (0x610A0000 + 160 * 1024)
#else
#define BL618DG_L2RAM_BASE           (0x21050000)
#define BL618DG_L2RAM_END            (0x21050000 + 128 * 1024)
#define BL618DG_L2RAM_CACHEABLE_BASE (0xA1050000)
#define BL618DG_L2RAM_CACHEABLE_END  (0xA1050000 + 128 * 1024)
#endif
//#define BL618DG_L2RAM_BUSREMAP_BASE            (0x230A0000)
//#define BL618DG_L2RAM_BUSREMAP_END             (0x230A0000 + 160 * 1024)
//#define BL618DG_L2RAM_BUSREMAP_CACHEABLE_BASE  (0x630A0000)
//#define BL618DG_L2RAM_BUSREMAP_CACHEABLE_END   (0x630A0000 + 160 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_XRAM_BASE           (0x210C8000)
#define BL618DG_XRAM_END            (0x210C8000 + 16 * 1024)
#define BL618DG_XRAM_CACHEABLE_BASE (0x610C8000)
#define BL618DG_XRAM_CACHEABLE_END  (0x610C8000 + 16 * 1024)
#else
#define BL618DG_XRAM_BASE           (0x210C0000)
#define BL618DG_XRAM_END            (0x210C0000 + 16 * 1024)
#define BL618DG_XRAM_CACHEABLE_BASE (0xA10C0000)
#define BL618DG_XRAM_CACHEABLE_END  (0xA10C0000 + 16 * 1024)
#endif
//#define BL618DG_XRAM_BUSREMAP_BASE             (0x230C8000)
//#define BL618DG_XRAM_BUSREMAP_END              (0x230C8000 + 16 * 1024)
//#define BL618DG_XRAM_BUSREMAP_CACHEABLE_BASE   (0x630C8000)
//#define BL618DG_XRAM_BUSREMAP_CACHEABLE_END    (0x630C8000 + 16 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_LPRAM_BASE (0x00000000)
#define BL618DG_LPRAM_END  (0x00000000 + 64 * 1024)
#else
#define BL618DG_LPRAM_BASE (0x00010000)
#define BL618DG_LPRAM_END  (0x00010000 + 64 * 1024)
#endif

#if defined(CPU_MODEL_A0)
#define BL618DG_FLASH_XIP_BASE        (0x80000000)
#define BL618DG_FLASH_XIP_END         (0x80000000 + 64 * 1024 * 1024)
#define BL618DG_FLASH_XIP_REMAP0_BASE (0xD0000000)
#define BL618DG_FLASH_XIP_REMAP0_END  (0xD0000000 + 64 * 1024 * 1024)
#else
#define BL618DG_FLASH_XIP_BASE        (0x30000000)
#define BL618DG_FLASH_XIP_END         (0x30000000 + 64 * 1024 * 1024)
#define BL618DG_FLASH_XIP_REMAP0_BASE (0xB0000000)
#define BL618DG_FLASH_XIP_REMAP0_END  (0xB0000000 + 64 * 1024 * 1024)
#endif
//#define BL618DG_FLASH_XIP_BUSREMAP_BASE        (0x10000000)
//#define BL618DG_FLASH_XIP_BUSREMAP_END         (0x10000000 + 64 * 1024 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_FLASH2_XIP_BASE        (0x84000000)
#define BL618DG_FLASH2_XIP_END         (0x84000000 + 64 * 1024 * 1024)
#define BL618DG_FLASH2_XIP_REMAP0_BASE (0xD4000000)
#define BL618DG_FLASH2_XIP_REMAP0_END  (0xD4000000 + 64 * 1024 * 1024)
#else
#define BL618DG_FLASH2_XIP_BASE        (0x34000000)
#define BL618DG_FLASH2_XIP_END         (0x34000000 + 64 * 1024 * 1024)
#define BL618DG_FLASH2_XIP_REMAP0_BASE (0xB4000000)
#define BL618DG_FLASH2_XIP_REMAP0_END  (0xB4000000 + 64 * 1024 * 1024)
#endif
//#define BL618DG_FLASH2_XIP_BUSREMAP_BASE       (0x14000000)
//#define BL618DG_FLASH2_XIP_BUSREMAP_END        (0x14000000 + 64 * 1024 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_PSRAM_BASE        (0x88000000)
#define BL618DG_PSRAM_END         (0x88000000 + 128 * 1024 * 1024)
#define BL618DG_PSRAM_REMAP0_BASE (0xD8000000)
#define BL618DG_PSRAM_REMAP0_END  (0xD8000000 + 128 * 1024 * 1024)
#else
#define BL618DG_PSRAM_BASE        (0x38000000)
#define BL618DG_PSRAM_END         (0x38000000 + 128 * 1024 * 1024)
#define BL618DG_PSRAM_REMAP0_BASE (0xB8000000)
#define BL618DG_PSRAM_REMAP0_END  (0xB8000000 + 128 * 1024 * 1024)
#endif
//#define BL618DG_PSRAM_BUSREMAP_BASE            (0xA8000000)
//#define BL618DG_PSRAM_BUSREMAP_END             (0xA8000000 + 128 * 1024 * 1024)

#if defined(CPU_MODEL_A0)
#define BL618DG_ALLRAM_BASE           (0x21000000)
#define BL618DG_ALLRAM_END            (0x21000000 + 320 * 1024 + 320 * 1024 + 160 * 1024 + 16 * 1024)
#define BL618DG_ALLRAM_CACHEABLE_BASE (0x61000000)
#define BL618DG_ALLRAM_CACHEABLE_END  (0x61000000 + 320 * 1024 + 320 * 1024 + 160 * 1024 + 16 * 1024)
#else
#define BL618DG_ALLRAM_BASE           (0x21000000)
#define BL618DG_ALLRAM_END            (0x21000000 + 320 * 1024 + 128 * 1024 + 320 * 1024 + 16 * 1024)
#define BL618DG_ALLRAM_CACHEABLE_BASE (0xA1000000)
#define BL618DG_ALLRAM_CACHEABLE_END  (0xA1000000 + 320 * 1024 + 128 * 1024 + 320 * 1024 + 16 * 1024)
#endif
//#define BL618DG_ALLRAM_BUSREMAP_BASE           (0x23000000)
//#define BL618DG_ALLRAM_BUSREMAP_END            (0x23000000 + 320 * 1024 + 320 * 1024 + 160 * 1024 + 16 * 1024 )
//#define BL618DG_ALLRAM_BUSREMAP_CACHEABLE_BASE (0x63000000)
//#define BL618DG_ALLRAM_BUSREMAP_CACHEABLE_END  (0x63000000 + 320 * 1024 + 320 * 1024 + 160 * 1024 + 16 * 1024 )

/*@} end of group Memory_Map_Section */

/* BL618DG peripherals base address */
/* WLSYS */
