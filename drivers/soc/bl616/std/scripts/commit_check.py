...
def check_commit_message(commit_msg, api_key):
    ...
    regex_pattern = re.compile(
        ...
        r'(?:\[(BL616)\])+'  # Group 2+: Chip models (one or more)
        r'\[('
        ...
        r'CPU|Clock|Power|Reset|Bus|'                       # Core and power management
        r'UART|SPI|I2C|PWM|GPADC|GPDAC|'                    # Communication and analog peripherals
        ...
        r'DMA|Sec_Eng|PEC'                                  # Data transfer and security
    ...
    if not match:
        ...
        print("Example:  [fix][BL616][UART] JIRA-123 Fix initialization bug")
