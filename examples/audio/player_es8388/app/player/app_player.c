...
/* The relevant configurations need to be adjusted in the board or the app configuration file */
//#define PA_PIN                 4
...
static void _fifo_task(void *arg)
{
    ...
    while (cnt < sizeof(music_mp3)) {
        ...
        /* Check whether the read end of the player's FIFO has exited (possible playback error) */
        ...
        /* Calculate the length of one write, which shall not exceed wlen. */
