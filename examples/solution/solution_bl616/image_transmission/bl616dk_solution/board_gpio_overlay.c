...
/* i2s gpio def */
#define I2S_FS_PIN                  (GPIO_PIN_13)
#define I2S_DI_PIN                  (GPIO_PIN_10)
#define I2S_DO_PIN                  (GPIO_PIN_11)
...
/* mclk def */
#define I2S_MCLK_PIN (GPIO_PIN_14)
/* mclk init */
