 ...
 *
 * @par Description:
 * Create a non-blocking mode encrypted TCP connection
 *
 * @param dst      [IN] Receiver's IP address.
 * @param port     [IN] Receiver's port number.
 *
 * @retval BL_TCP_ARG_INVALID           dst is empty.
 * @retval BL_TCP_CREATE_CONNECT_ERR    Failed to create connection.
 * @retval Greater than 0 Connection successful, returns the TCP socket.
 * Then use bl_TcpSslState to determine whether the connection is fully established.
 ...
 *
 * @par Description:
 * Query the status of an encrypted TCP connection
 *
 ...
 *
 * @par Description:
 * Non-blocking sending of encrypted TCP data
 *
 * @param fd      [IN] TCP socket.
 ...
 *
 * @par Description:
 * Non-blocking reading of encrypted TCP data
 *
 * @param fd      [IN] TCP socket.
