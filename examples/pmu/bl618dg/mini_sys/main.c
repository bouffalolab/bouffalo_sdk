...
void timer0_demo()
{
    ...
    //GLB_Set_NP2MINI_Interrupt_Mask(BL618DG_IRQ_TIMER0,0);
    ...
    //bflb_irq_attach(BL618DG_IRQ_E907_63_0, test_isr, NULL);
    //bflb_irq_enable(BL618DG_IRQ_E907_63_0);
...
int main(void)
{
    ...
    GLB_Set_NP2MINI_Interrupt_Clear(BL618DG_IRQ_E907_63_0);
    bflb_irq_clear_pending(BL618DG_IRQ_E907_63_0);
    /* mask all NP interrupt */
    GLB_Set_NP2MINI_Interrupt_Mask(BL618DG_IRQ_E907_63_0, 1);

    printf("BL618DG Mini Sys Shell\r\n");
