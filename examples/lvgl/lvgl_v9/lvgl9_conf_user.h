...
#ifndef CONFIG_LVGL9
#error "CONFIG_LVGL9 is not enabled"
#endif
...
/* LCD custom display buff def (lvgl_v9/port/lv_port_disp_xxx.c) */
#if 0
/* buff size */
#define LCD_LVGL_CUSTOM_DRAW_BUFF_SIZE ((LCD_W * LCD_H / 8) * (LCD_COLOR_DEPTH / 8))
/* buff address */
#define LCD_LVGL_CUSTOM_DRAW_BUFF(buff_n, buff_name) \
    __ALIGNED(64) uint8_t buff_name[LCD_LVGL_CUSTOM_DRAW_BUFF_SIZE]
#endif
...
#define LV_FS_LITTLEFS_LETTER 'L'  /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
