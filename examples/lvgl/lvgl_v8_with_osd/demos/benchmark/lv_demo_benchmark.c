...
static void report_cb(lv_timer_t *timer)
{
    ...
    if (opa_mode) {
        ...
        LV_LOG("Result of \"%s + opa\": %" LV_PRId32 " FPS", scenes[scene_act].name, scenes[scene_act].fps_opa);
    } else {
        ...
        LV_LOG("Result of \"%s\": %" LV_PRId32 " FPS", scenes[scene_act].name, scenes[scene_act].fps_normal);
    }
}
