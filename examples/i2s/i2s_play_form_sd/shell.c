...
static int cmd_cd( size_t argc, char **argv)
{
	int err;
...
static int cmd_ls( size_t argc, char **argv)
{
	FILINFO entry={0};
	DIR dir;
	int err;
...
static int cmd_pwd( size_t argc, char **argv)
{
	int err;
...
static int cmd_trunc( size_t argc, char **argv)
{
	FIL file;
	int length=0;
	int err;
...
static int cmd_mkdir( size_t argc, char **argv)
{
	int err;
...
static int cmd_rm( size_t argc, char **argv)
{
	int err;
...
SHELL_EXPORT_CMD(
SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_MAIN)|SHELL_CMD_DISABLE_RETURN,
pwd, cmd_pwd, get current path);

SHELL_EXPORT_CMD(
SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_MAIN)|SHELL_CMD_DISABLE_RETURN,
trunc, cmd_trunc, truncate the file);
