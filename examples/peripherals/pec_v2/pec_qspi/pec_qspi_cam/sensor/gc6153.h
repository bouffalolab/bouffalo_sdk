/* output format: YUYV */
struct bflb_pec_qspi_cam_s cam_cfg_gc6153 = {
    ...
    .pin_data_count = 1,                     /*!< QSPI CAM data pin count, must be power of 2, such as 1, 2, 4, 8 */
    .pin_pclk_idle_level = 0,                /*!< QSPI CAM pixel clock level when idle, 0: low level, others: high level */
    ...
    .delay_first_us = 0,                     /*!< delay time in microsecond before start capature camera data */
    ...
    .skip_clk_line = 12 * 8,                 /*!< skip clock count before every line */
