...
int main(void)
{
    ...
    /* Capture from external I2S codec, play back through builtin AUDAC/AUPWM. */
    wave_player_hw_cfg_t audio_hw_cfg = {
        ...
        .capture_backend = WAVE_PLAYER_BACKEND_I2S_CODEC,
    };
    ...
    printf("audio_dac_i2s_rec ready: ext codec capture + builtin audac playback\r\n");
    vTaskStartScheduler();
