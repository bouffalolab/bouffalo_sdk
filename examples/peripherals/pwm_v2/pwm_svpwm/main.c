...
int main(void)
{
    ...
    //         svpwm.v,
    //         svpwm.w);
    bflb_gpio_init(gpio, APP_KEY_0, GPIO_INPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_0);
    bflb_gpio_init(gpio, APP_KEY_1, GPIO_INPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_0);
    bflb_gpio_init(gpio, APP_KEY_2, GPIO_INPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_0);
    while (1) {
        bool key100 = bflb_gpio_read(gpio, APP_KEY_0);
        bool key10 = bflb_gpio_read(gpio, APP_KEY_1);
        bool key1 = bflb_gpio_read(gpio, APP_KEY_2);
