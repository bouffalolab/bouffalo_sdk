...
#define BL_TCP_ARG_INVALID             (-2)      /**< Invalid argument  */
#define BL_TCP_CREATE_CONNECT_ERR     (-21)      /**< Error creating TCP connection */
#define BL_TCP_SEND_ERR               (-23)      /**< TCP send failed */
#define BL_TCP_READ_ERR               (-25)      /**< TCP read failed */
#define BL_TCP_CONNECT_TIMEOUT        (-26)      /**< TCP connection timeout */
#define BL_TCP_CONNECT_ERR            (-27)      /**< TCP connection failed */
#define BL_TCP_CONNECTING             (-28)      /**< TCP connecting     */
#define BL_TCP_READ_INCOMPLETED       (-29)      /**< TCP packet read incomplete */
