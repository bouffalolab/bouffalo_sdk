...
void hal_boot2_get_efuse_cfg(boot2_efuse_hw_config *efuse_cfg)
{
   ...
   uint32_t sign_slot_offset = 0;
    ...
    /* get sw uasge 0 */
    bflb_ef_ctrl_read_direct(NULL, EF_DATA_0_EF_SW_USAGE_0_OFFSET, (uint32_t *)&sw_cfg0, 1, 1);
    /* get sw uasge 1 */
    //bflb_ef_ctrl_read_direct(NULL, EF_DATA_EF_SW_USAGE_1_OFFSET, (uint32_t *)&sw_cfg1, 1, 1);
