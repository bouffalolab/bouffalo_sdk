...
[r'make clean;make CHIP=bl618dg CPU_ID=ap BOARD=bl618dgdk CPU_MODEL=a0 CONFIG_DEBUG=n',"bl618dg_a0","release"],
[r'make clean;make CHIP=bl618dg CPU_ID=ap BOARD=bl618dgdk CPU_MODEL=a0 CONFIG_DEBUG=y',"bl618dg_a0","debug"],
[r'make clean;make CHIP=bl618dg CPU_ID=ap BOARD=bl618dgdk CPU_MODEL=b0 CONFIG_ANTI_ROLLBACK=y CONFIG_DEBUG=n',"bl618dg","release"],
[r'make clean;make CHIP=bl618dg CPU_ID=ap BOARD=bl618dgdk CPU_MODEL=b0 CONFIG_ANTI_ROLLBACK=y CONFIG_DEBUG=y',"bl618dg","debug"],
