...
#include "tests/riscv_dsp2_fir_q15.c"
#undef main
#undef ref_result
#undef result
#undef src
...
#include "tests/riscv_dsp2_matrix_q31.c"
#undef main
#undef ref_result
#undef result
#undef src
...
#include "tests/riscv_dsp2_rfft_q15.c"
#undef main
#undef ref_result
#undef result
#undef src
...
#include "tests/riscv_dsp2_sin_q31.c"
#undef main
#undef ref_result
#undef result
#undef src
...
#include "tests/riscv_dsp2_variance_q15.c"
#undef main
#undef ref_result
#undef result
#undef src
