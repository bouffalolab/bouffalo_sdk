...
function(sdk_set_linker_script_macro ld)
  if(IS_ABSOLUTE ${ld})
    set(path ${ld})
  else()
    set(path ${CMAKE_CURRENT_SOURCE_DIR}/${ld})
  ...
  set_property(GLOBAL PROPERTY LINKER_SCRIPT_IN ${path})
endfunction()
...
macro(project name)
  ...
  get_property(LINKER_SCRIPT_IN_PROPERTY GLOBAL PROPERTY LINKER_SCRIPT_IN)
  ...
  if(EXISTS ${LINKER_SCRIPT_IN_PROPERTY})
    set_target_properties(${proj_name}.elf PROPERTIES LINK_FLAGS "-T${SDK_DEMO_PATH}/${BUILD_DIR}/generated/linker.ld -Wl,-Map=${MAP_FILE}")
    set_target_properties(${proj_name}.elf PROPERTIES LINK_DEPENDS ${LINKER_SCRIPT_IN_PROPERTY})
  endif()
