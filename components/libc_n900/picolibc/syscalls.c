...
/*---------------------------------------------------------------------------
* Non-reentrant wrappers for stdio functions required by picolibc
*---------------------------------------------------------------------------*/
...
/* Forward declaration */
extern int _gettimeofday_r(struct _reent *reent, struct timeval *tp, void *tzp);
...
/* Forward declaration */
extern clock_t _times_r(struct _reent *reent, struct tms *ptms);
