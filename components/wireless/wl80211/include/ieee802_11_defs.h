...
enum mbo_cell_pref { MBO_CELL_PREF_EXCLUDED = 0, MBO_CELL_PREF_NO_USE = 1, MBO_CELL_PREF_USE = 255 };
...
/* P2P action frames */
enum p2p_act_frame_type { P2P_NOA = 0, P2P_PRESENCE_REQ = 1, P2P_PRESENCE_RESP = 2, P2P_GO_DISC_REQ = 3 };
...
static inline bool he_reg_is_indoor(uint8_t type) // ref @ enum he_reg_info_6ghz_ap_type
{
    return type == HE_REG_INFO_6GHZ_AP_TYPE_INDOOR || type == HE_REG_INFO_6GHZ_AP_TYPE_INDOOR_SP;
}

static inline bool he_reg_is_sp(uint8_t type) // ref @ enum he_reg_info_6ghz_ap_type
{
    return type == HE_REG_INFO_6GHZ_AP_TYPE_SP || type == HE_REG_INFO_6GHZ_AP_TYPE_INDOOR_SP;
}
...
#define EHT_PHYCAP_MU_BEAMFORMER_MASK \
    (EHT_PHYCAP_MU_BEAMFORMER_80MHZ | EHT_PHYCAP_MU_BEAMFORMER_160MHZ | EHT_PHYCAP_MU_BEAMFORMER_320MHZ)
...
#define EHT_PPE_THRES_NSS_MASK            ((u8)(BIT(0) | BIT(1) | BIT(2) | BIT(3)))
#define EHT_PPE_THRES_RU_INDEX_SHIFT      4
#define EHT_PPE_THRES_RU_INDEX_MASK       ((u16)(BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8)))
