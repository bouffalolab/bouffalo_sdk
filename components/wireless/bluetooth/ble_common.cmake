...
#
if(CONFIG_BL702L_A1)
	sdk_add_compile_definitions(-DCFG_BL702L_A1)
	set(CONFIG_BLE_TX_BUFF_DATA 2)
endif()
# 
# ifeq ($(CONFIG_BT_TL),1)
...
# CFLAGS   += -DCFG_IOT_SDK
# endif
sdk_add_compile_definitions_ifdef(CONFIG_BL_SDK -DCONFIG_BL_SDK)
