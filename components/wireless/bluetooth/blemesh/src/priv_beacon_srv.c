...
#include "crypto.h"
#include "net.h"
#include <conn.h>//#include <zephyr/bluetooth/conn.h>
#include "proxy.h"
...
static struct bt_mesh_model *priv_beacon_srv;//static const struct bt_mesh_model *priv_beacon_srv;
			      ...
			      struct bt_mesh_msg_ctx *ctx)
{
	...
	bt_mesh_model_send((struct bt_mesh_model *)mod, ctx, &buf, NULL, NULL);//bt_mesh_model_send(mod, ctx, &buf, NULL, NULL);

	return 0;
}

static void/*int*/ handle_beacon_get(/*const */struct bt_mesh_model *mod,
			     struct bt_mesh_msg_ctx *ctx,
...
static /*int*/void handle_beacon_set(/*const */struct bt_mesh_model *mod,
			     struct bt_mesh_msg_ctx *ctx,
			     struct net_buf_simple *buf)
{
	uint8_t beacon;
				  ...
				  struct bt_mesh_msg_ctx *ctx)
{
	...
	bt_mesh_model_send((struct bt_mesh_model *)mod, ctx, &buf, NULL, NULL);//origin:bt_mesh_model_send(mod, ctx, &buf, NULL, NULL);
}

static /*int*/void handle_gatt_proxy_get(/*const */struct bt_mesh_model *mod,
				 struct bt_mesh_msg_ctx *ctx,
				 struct net_buf_simple *buf)
{
	LOG_DBG("");
...
static /*int*/void handle_gatt_proxy_set(/*const */struct bt_mesh_model *mod,
				 struct bt_mesh_msg_ctx *ctx,
				 struct net_buf_simple *buf)
{
	uint8_t gatt_proxy;
			       ...
			       uint16_t net_idx, uint8_t node_id)
{
	...
	bt_mesh_model_send((struct bt_mesh_model *)mod, ctx, &buf, NULL, NULL);
}

static /*int*/void handle_node_id_get(/*const */struct bt_mesh_model *mod,
			      struct bt_mesh_msg_ctx *ctx,
			      struct net_buf_simple *buf)
{
	uint8_t status;
	...
	//fix bugs:status = bt_mesh_subnet_priv_node_id_get(net_idx, (enum bt_mesh_feat_state *)&node_id);
...
static /*int*/void handle_node_id_set(/*const */struct bt_mesh_model *mod,
			      struct bt_mesh_msg_ctx *ctx,
			      struct net_buf_simple *buf)
{
