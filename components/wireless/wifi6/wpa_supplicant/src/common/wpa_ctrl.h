...
#define AP_STA_POSSIBLE_SAE_CREDENTIAL_MISMATCH \
	"AP-STA-POSSIBLE-SAE-CREDENTIAL-MISMATCH "
#define AP_STA_POLL_OK "AP-STA-POLL-OK "
#define AP_STA_ENCRYPTION_TYPE_MISMATCH "AP-STA-ENCRYPTION-TYPE-MISMATCH "
#define STA_RX_EAPOL1 "STA-RX-EAPOL1"
#define STA_TX_EAPOL2 "STA-TX-EAPOL2"
#define STA_RX_EAPOL3 "STA-RX-EAPOL3"
#define STA_TX_EAPOL4 "STA-TX-EAPOL4"
