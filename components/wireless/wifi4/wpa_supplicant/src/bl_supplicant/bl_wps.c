...
static void wifi_event_cb_(platform_event_t *event, void *private_data)
{
...
static void wps_task_(void *pvParameters)
{
    ...
    platform_register_event(EV_WIFI, wifi_event_cb_, sm);
...
static int wifi_station_wps_deinit_(void)
{
    ...
    platform_unregister_event(EV_WIFI, wifi_event_cb_, sm);
