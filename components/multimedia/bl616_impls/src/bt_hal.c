...
/* Volume curve: The values in the array are the ID numbers corresponding to the db values for digital volume processing.
   The corresponding db values can be queried using the smta volmap command.*/
...
/* db_min and db_max are used to establish calculation factors corresponding to 256 db values. */
