...
/*!< The LOG level configured for the default LOG recorder; LOGs lower than this level will not be recorded  */
/*!< The LOG recorder level can be dynamically adjusted to modify the recorded content  */
...
/*!< Enable the file outputter split by time */
...
/*!< Line buffer size, which uses stack space; please ensure sufficient stack space */
/*!< If the line buffer size is set insufficiently, a single long LOG output may be incomplete */
...
/*!<  Logging function configured by the default logger */
