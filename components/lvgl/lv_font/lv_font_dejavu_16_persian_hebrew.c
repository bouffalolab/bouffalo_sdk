...
static const lv_font_fmt_txt_cmap_t cmaps[] = {
    ...
    { .range_start = 1734, .range_length = 61917, .glyph_id_start = 270, .unicode_list = unicode_list_7, .glyph_id_ofs_list = NULL, .list_length = 75, .type = LV_FONT_FMT_TXT_CMAP_SPARSE_TINY },
    { .range_start = 64338, .range_length = 82, .glyph_id_start = 345, .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY },
    { .range_start = 64426, .range_length = 715, .glyph_id_start = 427, .unicode_list = unicode_list_9, .glyph_id_ofs_list = NULL, .list_length = 31, .type = LV_FONT_FMT_TXT_CMAP_SPARSE_TINY },
    { .range_start = 65142, .range_length = 135, .glyph_id_start = 458, .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY },
    { .range_start = 65279, .range_length = 1, .glyph_id_start = 593, .unicode_list = NULL, .glyph_id_ofs_list = NULL, .list_length = 0, .type = LV_FONT_FMT_TXT_CMAP_FORMAT0_TINY }
};
