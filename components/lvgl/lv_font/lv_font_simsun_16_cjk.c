...
static const lv_font_fmt_txt_cmap_t cmaps[] = {
    ...
    { .range_start = 19968, .range_length = 43683, .glyph_id_start = 97, .unicode_list = unicode_list_1, .glyph_id_ofs_list = NULL, .list_length = 706, .type = LV_FONT_FMT_TXT_CMAP_SPARSE_TINY }
};
