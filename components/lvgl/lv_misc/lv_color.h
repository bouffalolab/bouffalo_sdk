...
#define LV_COLOR_SET_R(c, v)                  \
    LV_CONCAT(LV_COLOR_SET_R, LV_COLOR_DEPTH) \
    (c, v)
#define LV_COLOR_SET_G(c, v)                  \
    LV_CONCAT(LV_COLOR_SET_G, LV_COLOR_DEPTH) \
    (c, v)
#define LV_COLOR_SET_B(c, v)                  \
    LV_CONCAT(LV_COLOR_SET_B, LV_COLOR_DEPTH) \
    (c, v)
#define LV_COLOR_SET_A(c, v)                  \
    LV_CONCAT(LV_COLOR_SET_A, LV_COLOR_DEPTH) \
    (c, v)

#define LV_COLOR_GET_R(c)                     \
    LV_CONCAT(LV_COLOR_GET_R, LV_COLOR_DEPTH) \
    (c)
#define LV_COLOR_GET_G(c)                     \
    LV_CONCAT(LV_COLOR_GET_G, LV_COLOR_DEPTH) \
    (c)
#define LV_COLOR_GET_B(c)                     \
    LV_CONCAT(LV_COLOR_GET_B, LV_COLOR_DEPTH) \
    (c)
#define LV_COLOR_GET_A(c)                     \
    LV_CONCAT(LV_COLOR_GET_A, LV_COLOR_DEPTH) \
    (c)

#define _LV_COLOR_ZERO_INITIALIZER LV_CONCAT(_LV_COLOR_ZERO_INITIALIZER, LV_COLOR_DEPTH)
#define LV_COLOR_MAKE(r8, g8, b8)            \
    LV_CONCAT(LV_COLOR_MAKE, LV_COLOR_DEPTH) \
    (r8, g8, b8)
