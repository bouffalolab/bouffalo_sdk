...
eth_phy_drv_t ephy_general_drv = {
    ...
    .phy_deinit = ephy_general_deinit,
};
...
static int ephy_general_ability_check(eth_phy_ctrl_t *phy_ctrl, eth_phy_init_cfg_t *cfg, uint32_t *negotia_ability)
{
    ...
    eth_phy_mdio_read(phy_ctrl, phy_ctrl->phy_addr, EPHY_BASIC_STATUS_OFFSET, &regval);
...
int ephy_general_init(eth_phy_ctrl_t *phy_ctrl, eth_phy_init_cfg_t *cfg)
{
    ...
    eth_phy_mdio_read(phy_ctrl, phy_ctrl->phy_addr, EPHY_AUTONEG_ADVERTISE_OFFSET, &regval);
    /* 10BASE-TX ability */
    ...
    eth_phy_mdio_write(phy_ctrl, phy_ctrl->phy_addr, EPHY_AUTONEG_ADVERTISE_OFFSET, regval);
        ...
        case EPHY_CMD_GET_SPEED_MODE:
            ...
            if (regval & EPHY_CSR_AUTO_NEGOTIATION_EN_BIT) {
                ...
                if (regval & EPHY_BSR_AUTO_NEGOTIATE_COMPLETE_BIT) {
                    ...
                    eth_phy_mdio_read(phy_ctrl, phy_ctrl->phy_addr, EPHY_AUTONEG_ADVERTISE_OFFSET, &regval1);
                    /* get Auto-Negotiation Link Partner Ability Register  */
                    eth_phy_mdio_read(phy_ctrl, phy_ctrl->phy_addr, EPHY_AUTONEG_LINKPARTNER_OFFSET, &regval2);
                    /* get speed mode */
