...
#if (0)
#define VIRTUALCHAN(virtualchan, fmt, args...) pr_info("[mr_virtualchan] " fmt, ##args)
#else
#define VIRTUALCHAN_DBG(virtualchan, fmt, args...)
#endif

#if (1)
#define VIRTUALCHAN_INFO(virtualchan, fmt, args...) pr_notice("[mr_virtualchan] " fmt, ##args)
#else
#define VIRTUALCHAN_INFO(virtualchan, fmt, args...)
#endif

#define VIRTUALCHAN_ERR(virtualchan, fmt, args...) pr_err("[mr_virtualchan] " fmt, ##args)
/** @} */
