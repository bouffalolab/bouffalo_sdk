 ...
 * @brief Speed test module header definitions
...
#define MR_SPEED_TEST_BUFF_CNT (20)
/** Number of test rounds to perform */
#define MR_SPEED_TEST_CNT      (1000)
/** @} */

/**
 * @struct mr_speed_test
...
struct mr_speed_test {
     ...
     * @{
     */
    uint8_t *dnld_test_buff[MR_SPEED_TEST_BUFF_CNT]; /**< Download test buffers */
    uint8_t *upld_test_buff[MR_SPEED_TEST_BUFF_CNT]; /**< Upload test buffers */
    /** @} */
