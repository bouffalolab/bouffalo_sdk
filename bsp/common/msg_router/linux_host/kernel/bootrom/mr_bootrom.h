...
#define MR_BOOTROM_FW_NAME                       ("sdio_bootrom_test.bin")

/** Maximum command buffer size */
#define MR_BOOTROM_SDIO_CMD_BUFF_MAX             (2 * 1024)
/** Maximum acknowledgment buffer size */
#define MR_BOOTROM_SDIO_ACK_BUFF_MAX             (2 * 1024)

/** SDIO CPU group identifier */
#define MR_BOOTROM_SDIO_CPU_GROUP                (1)

/** SDIO transfer timeout (in 10us units) */
#define MR_BOOTROM_SDIO_TRANS_TIMEOUT            (1000 * 1000 / 10)

/** Maximum payload size for bootrom commands */
#define MR_BOOTROM_CMD_PAYLOAD_MAX               ((MR_BOOTROM_SDIO_CMD_BUFF_MAX - sizeof(bootrom_cmd_t)) & 0xfffffff0)
/** @} */
 ...
 * @{
 */
#define MR_BOOTROM_CMD_LEN_HEADER                (0x04) /**< Length header command */
#define MR_BOOTROM_CMD_BOOTINFO_GET              (0x10) /**< Get boot information */
#define MR_BOOTROM_CMD_BOOTHEADER_LOAD           (0x11) /**< Load boot header */
#define MR_BOOTROM_CMD_PK1_LOAD                  (0x12) /**< Load public key 1 */
#define MR_BOOTROM_CMD_PK2_LOAD                  (0x13) /**< Load public key 2 */
#define MR_BOOTROM_CMD_SIGNATURE1_LOAD           (0x14) /**< Load signature 1 */
#define MR_BOOTROM_CMD_SIGNATURE2_LOAD           (0x15) /**< Load signature 2 */
#define MR_BOOTROM_CMD_AESIV_LOAD                (0x16) /**< Load AES IV */
#define MR_BOOTROM_CMD_SECTIONHEADER_LOAD        (0x17) /**< Load section header */
#define MR_BOOTROM_CMD_SECTIONDATA_LOAD          (0x18) /**< Load section data */
#define MR_BOOTROM_CMD_CHECK_IMAGE               (0x19) /**< Check image integrity */
#define MR_BOOTROM_CMD_RUN                       (0x1A) /**< Run firmware */
#define MR_BOOTROM_CMD_LOAD_BOOTHEADER_SHA384_P2 (0x1B) /**< Load boot header SHA384 P2 */
#define MR_BOOTROM_CMD_CHANGE_RATE               (0x20) /**< Change transfer rate */
#define MR_BOOTROM_CMD_RESET                     (0x21) /**< Reset command */
#define MR_BOOTROM_CMD_FLASH_ERASE               (0x30) /**< Flash erase */
#define MR_BOOTROM_CMD_FLASH_WRITE               (0x31) /**< Flash write */
#define MR_BOOTROM_CMD_FLASH_READ                (0x32) /**< Flash read */
#define MR_BOOTROM_CMD_FLASH_BOOT                (0x33) /**< Flash boot */
#define MR_BOOTROM_CMD_EFUSE_WRITE               (0x40) /**< eFuse write */
#define MR_BOOTROM_CMD_EFUSE_READ                (0x41) /**< eFuse read */
/** @} */
 ...
 * @{
 */
#define MR_BOOTOM_ACK_STA_OK                     (0x4b4f) /**< Operation successful */
/** @} */
...
typedef struct boot_info_data {
     ...
     * @{
     */
    uint8_t sign_type[MR_BOOTROM_SDIO_CPU_GROUP];  /**< Signature type from eFuse */
    uint8_t encry_type[MR_BOOTROM_SDIO_CPU_GROUP]; /**< Encryption type from eFuse */
...
typedef struct mr_sdio_bootrom {
     ...
     * @{
     */
    uint8_t sdio_cmd_buff[MR_BOOTROM_SDIO_CMD_BUFF_MAX]; /**< Command buffer */
    uint8_t sdio_ack_buff[MR_BOOTROM_SDIO_ACK_BUFF_MAX]; /**< Acknowledgment buffer */
    /** @} */
} mr_sdio_bootrom_t;
