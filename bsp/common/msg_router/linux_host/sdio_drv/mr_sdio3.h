...
/**
 * @file mr_sdio3.h
 * @brief SDIO3 hardware interface header definitions
...
#ifndef __MR_SDIO3_H__
#define __MR_SDIO3_H__
...
#define MR_SDIO3_HOST_FN1_UPLD_SIZE_MAX   (1024 * 2)
/** Function 2 maximum host upload buffer size */
#define MR_SDIO3_HOST_FN2_UPLD_SIZE_MAX   (1024 * 2)
 ...
 */
#define SDIO3_CMD53_BYTE_MOD_SIZE_MAX(fn) \
    ((fn == 1) ? SDIO3_FN1_CMD53_BYTE_MOD_SIZE_MAX : SDIO3_FN2_CMD53_BYTE_MOD_SIZE_MAX)
