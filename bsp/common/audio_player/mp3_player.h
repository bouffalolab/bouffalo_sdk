...
#ifndef CONFIG_MP3_PLAYER_CACHE_BYTES
#define MP3_PLAYER_CACHE_BYTES 4096U
#else
#define MP3_PLAYER_CACHE_BYTES CONFIG_MP3_PLAYER_CACHE_BYTES
#endif

#ifndef CONFIG_MP3_PLAYER_RESAMPLE_TX_BLOCK_BYTES
#define MP3_PLAYER_RESAMPLE_TX_BLOCK_BYTES 0U
#else
#define MP3_PLAYER_RESAMPLE_TX_BLOCK_BYTES CONFIG_MP3_PLAYER_RESAMPLE_TX_BLOCK_BYTES
#endif
