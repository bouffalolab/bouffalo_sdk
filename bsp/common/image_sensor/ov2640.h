...
#define OV2640_SIZE_1600X1200 0
#define OV2640_SIZE_800X600   1
#define OV2640_SIZE_USE       OV2640_SIZE_1600X1200

static struct image_sensor_command_s ov2640_init_list[] = {
#if(OV2640_SIZE_USE == OV2640_SIZE_1600X1200)
    {0xff, 0x00},
    {0x2c, 0xff},
    {0x2e, 0xdf},
    {0xff, 0x01},
...
#elif(OV2640_SIZE_USE == OV2640_SIZE_800X600)
    {0xff, 0x00},
    {0x2c, 0xff},
    {0x2e, 0xdf},
    {0xff, 0x01},
