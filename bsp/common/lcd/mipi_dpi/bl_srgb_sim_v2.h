...
#ifndef _BL_SRGB_SIM_V2_H_
#define _BL_SRGB_SIM_V2_H_

#include "../lcd_conf.h"

#if defined(LCD_DPI_SIM_V2_ENABLE)

#define LCD_SRGB_SIM_V2_PIXEL_FORMAT_RGB565   0
#define LCD_SRGB_SIM_V2_PIXEL_FORMAT_NRGB8888 1
#define LCD_SRGB_SIM_V2_PIXEL_FORMAT_RGB888  2

#define LCD_SRGB_SIM_V2_FRAME_INT_TYPE_CYCLE  0
#define LCD_SRGB_SIM_V2_FRAME_INT_TYPE_SWAP   1
...
typedef struct {
    ...
    uint16_t frame_rate; /* Reserved for compatibility */
    uint16_t pixel_format;
    uint8_t de_mode_en;

    void *frame_buff; /* The frame buffer */
} lcd_srgb_sim_v2_init_t;
