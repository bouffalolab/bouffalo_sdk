...
/* Color reversal */
#if defined(GC9307_SPI_COLOR_REVERSAL) && GC9307_SPI_COLOR_REVERSAL
    { 0x21, NULL, 0 },
#endif
...
#if defined(GC9307_SPI_DIR_MIRROR) && GC9307_SPI_DIR_MIRROR
    mir_flag = !mir_flag;
#endif
...
/* Color RGB order */
#if defined(GC9307_SPI_COLOR_ORDER) && GC9307_SPI_COLOR_ORDER
    param |= 0x08;
#endif
...
{
#if defined(GC9307_SPI_OFFSET_X) && GC9307_SPI_OFFSET_X
    x1 += GC9307_SPI_OFFSET_X;
    x2 += GC9307_SPI_OFFSET_X;
#endif
#if defined(GC9307_SPI_OFFSET_Y) && GC9307_SPI_OFFSET_Y
