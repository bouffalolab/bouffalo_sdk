...
#define APP_PWM_PIN_U_H   (GPIO_PIN_0)
#define APP_PWM_PIN_U_L   (GPIO_PIN_1)
#define APP_PWM_PIN_V_H   (GPIO_PIN_2)
#define APP_PWM_PIN_V_L   (GPIO_PIN_3)
#define APP_PWM_PIN_W_H   (GPIO_PIN_4)
#define APP_PWM_PIN_W_L   (GPIO_PIN_5)
#define APP_HALL_PIN_U    (GPIO_PIN_12)
#define APP_HALL_PIN_V    (GPIO_PIN_14)
#define APP_HALL_PIN_W    (GPIO_PIN_15)
#define APP_KEY_0         (GPIO_PIN_29)
#define APP_KEY_1         (GPIO_PIN_30)
#define APP_KEY_2         (GPIO_PIN_31)
#define APP_CURRENT_CH_U  (ADC_CHANNEL_0)
#define APP_CURRENT_CH_V  (ADC_CHANNEL_1)
#define APP_CURRENT_CH_W  (ADC_CHANNEL_2)
#define APP_CURRENT_PIN_U (GPIO_PIN_11)
#define APP_CURRENT_PIN_V (GPIO_PIN_13)
#define APP_CURRENT_PIN_W (GPIO_PIN_16)
#define APP_TEST_PIN      (GPIO_PIN_32)
