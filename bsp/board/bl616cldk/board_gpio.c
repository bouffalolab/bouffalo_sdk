...
void board_sdio_gpio_deinit(void)
{
    ...
    bflb_gpio_init(gpio, GPIO_PIN_8, GPIO_INPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_0);
    bflb_gpio_init(gpio, GPIO_PIN_9, GPIO_INPUT | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_0);
